...
if(empty($_GET['id'])) {
  redirect("salon.guest-bookings.php");
} else {
    
  $booking = Guest_booking::find_by_id($_GET['id']);
  
  if (isset($_POST['update'])) {
    if($booking) {
      $booking->booking_text = $_POST['booking_text'];
        
      if ($booking->save()) { redirect("salon.guest-bookings.php"); }
    }
  }  
}
...
?>
    ...
    <div class="col-md-9 content">
      ...
      <div class="text-right">
        <a class="btn btn-outline-danger" href="salon.delete-guest-booking.php?id=<?php echo $booking->id; ?>">
      ...
      <div class="list-group mb-3">
        ...
        <li class="list-group-item justify-content-between">
          ...
          <span class="ml-a"><?php echo $booking->guest_name; ?></span>
        </li>
        <li class="list-group-item justify-content-between">
          <span>Guest tel</span>
          <span class="ml-a"><?php echo $booking->guest_tel; ?></span>
        </li>
      </div>
